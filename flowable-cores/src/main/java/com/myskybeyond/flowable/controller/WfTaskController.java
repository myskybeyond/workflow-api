...
public class WfTaskController {
    ...
    public TableDataInfo<WfTaskVo> taskList(ProcessQuery processQuery, PageQuery pageQuery) {
        return flowTaskService.selectPageTaskList(processQuery, pageQuery);
    }
    ...
    @SaCheckPermission("workflow:task:terminated")
    public R closeTask(@RequestBody WfTaskBo bo) {
        flowTaskService.closeTask(bo);
        return R.ok();
    }
    // 任务挂起
    @PostMapping(value = "/assume")
    @SaCheckPermission("workflow:task:assume")
    public R assumeTask(@RequestBody WfTaskBo bo) {
        flowTaskService.assumeTask(bo);
        return R.ok();
    }
    // 任务激活
    @PostMapping(value = "/active")
    @SaCheckPermission("workflow:task:active")
    public R activeTask(@RequestBody WfTaskBo bo) {
        flowTaskService.activeTask(bo);
        return R.ok();
    }
}
