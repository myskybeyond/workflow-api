...
public class SysMenuController extends BaseController {
    ...
    public R<List<RouterVo>> getRouters() {
        Boolean forceResetPassObj = NewUserUtils.getForceResetPassValue(LoginHelper.getUserId());
        boolean forceResetPass = Objects.nonNull(forceResetPassObj) ? forceResetPassObj : false;
